...
export default function LinkPage() {
  ...
  return <AuthGuard><main className="shell"><Nav />
    <div className="page-heading-row"><div><h1>Link</h1><p className="page-kicker">Clientes pendientes · notas automáticas</p></div><span className="viz-like-count">{pendingCount}</span></div>
