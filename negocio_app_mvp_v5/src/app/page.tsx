...
export default function Home() {
  ...
  const cargar = useCallback(async () => {
    ...
    const [walletRes, settingsRes, salesRes, createdRes, pendingRes, historyRes] = await Promise.all([
    ...
    const firstError = walletRes.error || settingsRes.error || salesRes.error || createdRes.error || pendingRes.error || historyRes.error;
