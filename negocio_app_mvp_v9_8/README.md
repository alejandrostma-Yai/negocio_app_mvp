...
Estados de seguimiento en Teléfonos y toggle AGG en Link.
...
## v8.5
- Separa instalación de cobro.
- Las órdenes instaladas pasan a Pendiente de pago.
- Solo Cobrado suma al Monto bruto del día y al cierre.


## v8.6
Cierre diario/semanal, Bloc en Inicio con autosave, contador +1 y cronómetro.
